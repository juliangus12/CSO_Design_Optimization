...
infile<-paste(main_path,"/dataset/cordex/GFDL-ESM2M.WRF.txt",sep='')
...
save(run2,file=paste(main_path,"/projections/results/GFDLesm2m_WRF/Mu_nonstat_widenorm_run2_RCM.RData",sep=""))
cred.table
save(cred.table,file=paste(main_path,"/projections/results/GFDLesm2m_WRF/Mu_nonstat_widenorm_CI_RCM.RData",sep=""))
mu0=run2$finmat[,1]
amu=run2$finmat[,4]
...
gg=2019
 ...
 save(muproj_chain,xi_chain,sigma_chain,file=paste(main_path,'/projections/results/GFDLesm2m_WRF/nonstat_param',gg,'.RData',sep=""))}
